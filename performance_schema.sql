...
--
-- テーブルの構造 `events_stages_history_long`
--
...
--
-- テーブルの構造 `events_stages_summary_by_account_by_event_name`
--
...
--
-- テーブルの構造 `events_stages_summary_by_host_by_event_name`
--
...
--
-- テーブルの構造 `events_stages_summary_by_thread_by_event_name`
--
...
--
-- テーブルの構造 `events_stages_summary_by_user_by_event_name`
--
...
--
-- テーブルの構造 `events_stages_summary_global_by_event_name`
--
...
--
-- テーブルの構造 `events_statements_current`
--
...
--
-- テーブルの構造 `events_statements_history`
--
...
--
-- テーブルの構造 `events_statements_history_long`
--
...
--
-- テーブルの構造 `events_statements_summary_by_account_by_event_name`
--
...
--
-- テーブルの構造 `events_statements_summary_by_digest`
--
...
--
-- テーブルの構造 `events_statements_summary_by_host_by_event_name`
--
...
--
-- テーブルの構造 `events_statements_summary_by_thread_by_event_name`
--
...
--
-- テーブルの構造 `events_statements_summary_by_user_by_event_name`
--
...
--
-- テーブルの構造 `events_statements_summary_global_by_event_name`
--
...
--
-- テーブルの構造 `events_waits_history_long`
--
...
--
-- テーブルの構造 `events_waits_summary_by_account_by_event_name`
--
...
--
-- テーブルの構造 `events_waits_summary_by_host_by_event_name`
--
...
--
-- テーブルの構造 `events_waits_summary_by_instance`
--
...
--
-- テーブルの構造 `events_waits_summary_by_thread_by_event_name`
--
...
--
-- テーブルの構造 `events_waits_summary_by_user_by_event_name`
--
...
--
-- テーブルの構造 `events_waits_summary_global_by_event_name`
--
...
--
-- テーブルの構造 `file_summary_by_event_name`
--
...
--
-- テーブルの構造 `file_summary_by_instance`
--
...
--
-- テーブルの構造 `objects_summary_global_by_type`
--
...
--
-- テーブルの構造 `session_account_connect_attrs`
--
...
--
-- テーブルの構造 `socket_summary_by_event_name`
--
...
--
-- テーブルの構造 `socket_summary_by_instance`
--
...
--
-- テーブルの構造 `table_io_waits_summary_by_index_usage`
--
...
--
-- テーブルの構造 `table_io_waits_summary_by_table`
--
...
--
-- テーブルの構造 `table_lock_waits_summary_by_table`
--
